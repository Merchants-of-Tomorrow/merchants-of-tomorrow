...
const navigation = {
  categories: [
      ...
      sections: [
        {
          ...
          name: 'Themes',
          items: [
            { name: 'Powerhouse', href: '#' },
            { name: 'Disorderly', href: '#' },
            { name: 'Delores', href: '#' },
            { name: 'Monument', href: '#' },
          ],
        },
    ...
    },
    {
      ...
      featured: [
        {
          name: 'Powerhouse Companion',
          href: '#',
          imageSrc: 'https://tailwindui.com/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg',
          imageAlt: 'Drawstring top with elastic loop closure and textured interior padding.',
        },
        {
          name: 'Powerhouse Forms',
          href: '#',
      ...
      sections: [
        {
          ...
          items: [
            ...
            { name: 'AI Shopkeeper', href: '#' },
            { name: 'App Bundles', href: '#' },
            { name: 'Theme Companions', href: '#' },
